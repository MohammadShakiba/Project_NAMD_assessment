...
#pref = F"{tsh_method}_ntraj_{args.ntraj}_iter_{args.iter}_wp_width_{args.wpwidth}"
pref = F"{tsh_method}_ntraj_{args.ntraj}_iter_{args.iter}_wp_width_{args.wpwidth}_SSY"
