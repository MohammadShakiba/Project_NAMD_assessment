...
dyn_general = { "nsteps":args.nsteps, "ntraj":args.ntraj, "nstates":NSTATES,
                ...
                "properties_to_save":[ "time", "sh_pop_adi", "Epot_ave", "Ekin_ave", "Etot_ave" ],  
                "prefix":"", "prefix2":"",
...
# ============ SDM
    ...
    if dectime=='edc':
        ...
        dyn_general.update({"Temperature": args.temperature, "reorg_energy": 0.0125, "decoherence_times_type": 4 })
# ============ MFSD 
elif mqcmethod==6:
    dyn_general.update({"tsh_method":-1 }) # adiabatic, no surface hopping
    dyn_general.update({ "decoherence_algo":4}) # mfsd
    if dectime=='edc':
        folder_prefix = 'MFSD_EDC'
        dyn_general.update( { "decoherence_times_type":1, "decoherence_C_param": 1.0, "decoherence_eps_param": args.eps } )  # EDC + default params
    elif dectime=='schw1':
        folder_prefix = 'MFSD_SCHW1'
        ...
        folder_prefix = 'MFSD_SCHW2'
        dyn_general.update( { "decoherence_times_type":3, "schwartz_decoherence_inv_alpha":A } ) # Schwartz version 2
    elif dectime=='gu_franco':
        folder_prefix = 'MFSD_Gu_Franco' 
        dyn_general.update({"Temperature": args.temperature, "reorg_energy": 0.0125, "decoherence_times_type": 4 })
# ============ DISH_REV23
elif mqcmethod==7:
    ...
    if dectime=='edc':
        ...
        dyn_general.update({"Temperature": args.temperature, "reorg_energy": 0.0125, "decoherence_times_type": 4 })
# ============ New_decoherence_method with Gu-Franco
elif mqcmethod==8:
    folder_prefix = 'new_decoherence_with_Gu_Franco'
    dyn_general.update({"Temperature": args.temperature, "reorg_energy": 0.0125, "decoherence_algo":9, "decoherence_times_type":4 })
...
if dectime=='edc':
    ...
    pref = pref + F'_temperature_{args.temperature}' 
