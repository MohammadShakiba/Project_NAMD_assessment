...
for tshmethod in fssh fssh2 gfsh; do 
  for mqcmethod in 1 2 3 ; do
    sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod $mqcmethod --ntraj $ntraj --nsteps $nstep --dt 20.0 /g" submit_template.slm
...
for tshmethod in fssh fssh2 gfsh; do
  ...
  #for wpwidth in 0.0001 0.001 0.005  ; do
    sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod 4 --ntraj $ntraj --nsteps $nstep --dt 20.0 --wpwidth $wpwidth /g" submit_template.slm
...
for tshmethod in fssh fssh2 gfsh; do
  for mqcmethod in 5 6 7 ; do
    for eps in 0.01 0.05 0.1 0.2 0.4 1.0 5.0 10.0 20.0 40.0 80.0 ; do
      sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod $mqcmethod --dectime edc --ntraj $ntraj --nsteps $nstep --dt 20.0 --eps $eps /g" submit_template.slm
...
for tshmethod in fssh fssh2 gfsh; do
  for mqcmethod in 5 6 7 ; do
    for A in 0.0001 0.001 0.01 0.1 1.0 10.0 ; do
      sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod $mqcmethod --dectime schw1 --ntraj $ntraj --nsteps $nstep --dt 20.0 --A $A /g" submit_template.slm
...
for tshmethod in  gfsh; do
#for tshmethod in fssh fssh2 gfsh; do
  #for mqcmethod in 5 6 7 ; do
  for mqcmethod in 6 ; do
    #for A in 0.1 1.0 ; do
    for A in 0.0001 0.001 0.01 0.1 1.0 10.0 20.0; do
      sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod $mqcmethod --dectime schw2 --ntraj $ntraj --nsteps $nstep --dt 20.0 --A $A /g" submit_template.slm
...
for tshmethod in fssh fssh2 gfsh; do
  for mqcmethod in 5 6 7 ; do
    sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod $mqcmethod --dectime gu_franco --ntraj $ntraj --nsteps $nstep --dt 20.0 /g" submit_template.slm
...
for tshmethod in fssh fssh2 gfsh; do
  sed -i "s/python.*/python spin_boson_2_states.py --iter 0 --tshmethod $tshmethod --mqcmethod 8 --dectime gu_franco --ntraj $ntraj --nsteps $nstep --dt 20.0 /g" submit_template.slm
